...
static GstMemory *
sunxi_v4l2_mem_copy(GstMemory *mem, gssize offset, gssize size)
{
    GstMemory *ret;

    ret = gst_allocator_alloc(NULL, 0, NULL);
...
gst_allocator_sunxiv4l2_init(GstAllocatorSunxiV4l2 *allocator)
{
    ...
    alloc->mem_copy = sunxi_v4l2_mem_copy;
